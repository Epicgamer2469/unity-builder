...
const ruleset_1 = __webpack_require__(13341);
...
var httpAuthSchemeProvider = __webpack_require__(49344);
var runtimeConfig = __webpack_require__(19756);
...
const package_json_1 = tslib_1.__importDefault(__webpack_require__(91092));
const core_1 = __webpack_require__(59963);
...
const runtimeConfig_shared_1 = __webpack_require__(44809);
...
const httpAuthSchemeProvider_1 = __webpack_require__(49344);
const endpointResolver_1 = __webpack_require__(30898);
const getRuntimeConfig = (config) => {
    return {
...
const resolveSSOCredentials = async ({ ssoStartUrl, ssoSession, ssoAccountId, ssoRegion, ssoRoleName, ssoClient, clientConfig, parentClientConfig, callerClientConfig, profile, filepath, configFilepath, ignoreCache, logger, }) => {
    ...
    const { SSOClient, GetRoleCredentialsCommand } = await Promise.resolve().then(function () { return __webpack_require__(84374); });
    const sso = ssoClient ||
...
var clientSso = __webpack_require__(82666);
...
const getSsoOidcClient = async (ssoRegion, init = {}, callerClientConfig) => {
    const { SSOOIDCClient } = await __webpack_require__.e(/* import() */ 334).then(__webpack_require__.t.bind(__webpack_require__, 27334, 19));
...
const getNewSsoOidcToken = async (ssoToken, ssoRegion, init = {}, callerClientConfig) => {
    const { CreateTokenCommand } = await __webpack_require__.e(/* import() */ 334).then(__webpack_require__.t.bind(__webpack_require__, 27334, 19));
